...
renderHomeData(){
    const html = this.data.map((items) =>{
        ...
        <button class="get-btn"><a class="home-A" target="_blank" download href="https://drive.google.com/file/d/10HniB2BIqVBfCqSXAY0BsPOwCNyQDXvU/view?usp=drive_link" download >download cv</a></button>
